...
public class GameManager : MonoBehaviour
{
    ...
    public float finalMoveSpeed = 5f;
    ...
    private void InitializeGame() {
        ...
        while (playersToSpawn > 0)
        {
            ...
            playerSpawners[r].spawnPlayer(player, GetComponent<GameManager>(), playerCount);
    ...
    void SpawnEnemiesIntoRound() {
            ...
            //Spawn the enemies into the game (will be changed later to check what spawns are active but for now go to hell)
            enemySpawners[Random.Range(0, enemySpawners.Count)].SpawnEnemies(enemy, enemiesHealth, startingMoveSpeed, enemiesToSpawnTemp);
